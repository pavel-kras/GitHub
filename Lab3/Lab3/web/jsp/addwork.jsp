...
<html>
    ...
    <center>
        <form class="form-style" name="addwork" method="POST"
              action="servlet">
            <input type="hidden" name="command" value="addwork" autofocus/>
            <h1><font color="#ffffff" face="TrixiePro">Название работы</font></h1>
            <input type="text" name="title" value="${title}" required/><br>
            <h1><font color="#ffffff" face="TrixiePro">Время выпонения</font></h1>
            <input type="text" name="time" value="${time}" required pattern="^[0-9]+$"><br />
            <h1><font color="#ffffff" face="TrixiePro">Цена работ</font></h1>
